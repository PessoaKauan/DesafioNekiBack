...
import br.com.desafioneki.domain.Skill;
...
import br.com.desafioneki.dto.PutLevelSkillDTO;
import br.com.desafioneki.dto.SkillDTO;
import br.com.desafioneki.exceptions.NotFoundException;
import br.com.desafioneki.repository.SkillRepository;
import br.com.desafioneki.repository.SkillUsuarioRepository;
import br.com.desafioneki.repository.UsuarioRepository;
...
public class SkillService {
	...
	public void atualizarLevelSkill(PutLevelSkillDTO dtoPut) {
        ...
        if (usuarioOptional.isEmpty()) {
            throw new NotFoundException("Não há um usuario cadastrado no ID: " + dtoPut);
        }
        ...
        if (usuarioSkillOptional.isEmpty()) {
            throw new NotFoundException("Não há uma skill no ID: " + dtoPut);
        }
